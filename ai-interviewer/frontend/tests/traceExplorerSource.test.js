...
test("trace explorer detail pane uses Chinese keys for backend evidence fields", () => {
  ...
  assert.match(component, /ContractMustCoverPanel/);
  assert.match(component, /values=\{mustCover\}/);
  assert.match(component, /ContractAcceptanceOverview/);
  assert.match(component, /values=\{acceptanceChecks\}/);
...
test("trace explorer productizes structured scoring contract display", () => {
  const component = read("src/components/admin/TraceExplorer.tsx");

  assert.match(component, /ContractAcceptanceOverview/);
  assert.match(component, /ContractAcceptanceFilters/);
  ...
  assert.match(component, /Gate 校准审计/);
  assert.match(component, /high_score_gate_failed/);
  assert.match(component, /partial_only_gate_failed/);
  assert.match(component, /hard_failure_gate_failed/);
  assert.match(component, /audit-only strictness signals/);
  assert.match(component, /SoftGapTrainingSuggestionsPanel/);
  assert.match(component, /SoftFollowupHintsPanel/);
  assert.match(component, /soft_gap_training_suggestions/);
  assert.match(component, /soft_followup_hints/);
  assert.match(component, /contract_semantics_summary/);
  assert.match(component, /contract_semantics_summaries/);
  assert.match(component, /quality_suggestions/);
  assert.match(component, /context_suggestions/);
  assert.match(component, /quality_hints/);
  assert.match(component, /context_hints/);
  assert.match(component, /probe_quality_gap/);
  assert.match(component, /probe_context_gap/);
  assert.match(component, /追问意图草稿/);
  assert.match(component, /质量追问/);
  assert.match(component, /上下文追问/);
  assert.match(component, /applied=false/);
  assert.match(component, /soft_quality_gap_count/);
  assert.match(component, /context_gap_count/);
  assert.match(component, /must_cover = scoring scope/);
  assert.match(component, /reviewed core = hard gate/);
  assert.match(component, /reviewed supporting = quality signals/);
  assert.match(component, /adaptive context = context signals/);
  assert.match(component, /质量补强建议/);
  assert.match(component, /上下文补强建议/);
  assert.match(component, /reviewed_supporting becomes quality/);
  assert.match(component, /adaptive_context becomes context/);
  assert.match(component, /grid gap-3 2xl:grid-cols-\[minmax\(0,1fr\)_minmax\(320px,420px\)\]/);
  assert.match(component, /条款层级关系/);
  assert.match(component, /评分范围/);
  assert.match(component, /核心底线/);
  assert.match(component, /质量细分/);
  assert.match(component, /上下文补充/);
  assert.match(component, /reviewed\/core/);
  assert.match(component, /reviewed\/supporting/);
  assert.match(component, /定义本题评分范围/);
  assert.match(component, /不直接作为逐条 gate/);
  assert.match(component, /reviewed core/);
  assert.match(component, /reviewed supporting/);
  assert.match(component, /adaptive_context/);
  assert.match(component, /compiled_fallback/);
  assert.match(component, /rewrite_fallback/);
  assert.match(component, /evaluator_extra/);
  assert.match(component, /contract_acceptance_mode/);
  assert.match(component, /reviewed_core_summary/);
  assert.match(component, /reviewed_core_failed/);
  assert.match(component, /sourceFilter/);
  assert.match(component, /severityFilter/);
  assert.match(component, /verdictFilter/);
  assert.match(component, /contractItemQuery/);
  assert.match(component, /legacy_acceptance_checks_fallback/);
  assert.match(component, /legacy_acceptance_check_results_fallback/);
  assert.match(component, /gate_failed_item/);
  assert.match(component, /acceptanceVerdictRank/);
  assert.match(component, /contractAcceptanceSearchText/);
  assert.match(component, /acceptanceItemResultByKey/);
});
...
test("trace explorer explains successor workflow nodes with dedicated panels", () => {
  ...
  assert.match(component, /contract_gate_results/);
  assert.match(component, /AcceptanceCheckResultItemsList/);
...
test("trace explorer search covers structured ask_question evidence fields", () => {
  ...
  assert.match(component, /record\.contract_semantics_summary/);
  assert.match(component, /record\.contract_semantics_summaries/);
  assert.match(component, /record\.gate_calibration_summary/);
  assert.match(component, /record\.gate_calibration_summaries/);
  assert.match(component, /record\.soft_gap_training_suggestions/);
  assert.match(component, /record\.soft_followup_hints/);
  assert.match(component, /acceptance_checks/);
  ...
  assert.match(component, /addGateCalibrationSummarySearchFields/);
  assert.match(component, /addContractSemanticsSummarySearchFields/);
  assert.match(component, /addSoftGapTrainingSuggestionsSearchFields/);
  assert.match(component, /addSoftFollowupHintsSearchFields/);
  assert.match(component, /contractAcceptanceSearchText/);
  assert.match(component, /contract_acceptance_mode/);
  assert.match(component, /sourceFilter/);
  assert.match(component, /severityFilter/);
